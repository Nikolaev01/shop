...
class AbstractSelect{
    private $db;//
    private $from = "";//
    private $where = "";//условие
    private $order = "";//сортировка
    private $limit = "";//смещение
    //
    public function __construct($db){
        $this->db = $db;//принимаем объект
    }
    //метод записывающий значение from в селект
    ...
    //метод записывающий значение where в селект одинарный
    ...
    //Метод запрос формата множества
    ...
    //Метод получения рандомного значения
